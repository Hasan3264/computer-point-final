...
<head>
    ...
    <title>Computer Point Dashboard</title>
    <!-- Favicon icon -->
    ...
    {{-- <link rel="stylesheet" href="{{asset('Frontend/assets/css/jQuery-mooZoom-1.0.0.css')}}"> --}}
</head>
<body>
								...
								<ul class="contacts">
									...
									<li class="active dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="{{asset('/deshboard/images/avatar/1.jpg')}}" class="rounded-circle user_img" alt=""/>
									...
									<li class="dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="{{asset('/deshboard/images/avatar/2.jpg')}}" class="rounded-circle user_img" alt=""/>
									...
									<li class="dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="{{asset('/deshboard/images/avatar/3.jpg')}}" class="rounded-circle user_img" alt=""/>
												<span class="online_icon"></span>
											</div>
											<div class="user_info">
									...
									<li class="dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="{{asset('/deshboard/images/avatar/4.jpg')}}" class="rounded-circle user_img" alt=""/>
												<span class="online_icon offline"></span>
											</div>
											<div class="user_info">
									...
									<li class="dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="{{asset('/deshboard/images/avatar/5.jpg')}}" class="rounded-circle user_img" alt=""/>
												<span class="online_icon offline"></span>
											</div>
											<div class="user_info">
                        ...
                        <ul class="navbar-nav header-right">
							...
							<li class="nav-item dropdown notification_dropdown">
                                <a class="nav-link  ai-icon" href="javascript:void(0)" role="button" data-toggle="dropdown">
                                    ...
                                    @if (App\Models\Careeraplication::count() > 0)
                                    {{App\Models\Careeraplication::count()}}
                                    <div class="pulse-css text-red"></div>
                                    @endif
                                </a>
                                <div class="dropdown-menu rounded dropdown-menu-right">
                                    <div id="DZ_W_Notification1" class="widget-media dz-scroll p-3 height380">
										<ul class="timeline">
											@foreach (App\Models\Careeraplication::all() as $carrear)
                                            <li>
												<div class="timeline-panel">
													<div class="media mr-2">
														<img alt="image" width="50" src="{{asset('/deshboard/images/avatar/1.jpg')}}">
													</div>
													<div class="media-body">
														<a href="{{route('applicante.index')}}">
                                                            <h6 class="mb-1">{{$carrear->name}}</h6>
                                                            <small class="d-block">{{$carrear->email}}</small></a>
													</div>
												</div>
											</li>
											@endforeach
							...
							<li class="nav-item dropdown notification_dropdown">
                                <a class="nav-link  ai-icon" href="javascript:void(0)" role="button" data-toggle="dropdown">
                                    ...
                                    @if (App\Models\Clinte_massge::count() > 0)
                                    {{App\Models\Clinte_massge::count()}}
                                    <div class="pulse-css text-red"></div>
                                    @endif
                                </a>
                                <div class="dropdown-menu rounded dropdown-menu-right">
                                    <div id="DZ_W_Notification1" class="widget-media dz-scroll p-3 height380">
										<ul class="timeline">
											@foreach (App\Models\Clinte_massge::all() as $clintmassage)
                                            <li>
												<div class="timeline-panel">
													<div class="media mr-2">
														<img alt="image" width="50" src="{{asset('/deshboard/images/avatar/1.jpg')}}">
													...
													<div class="media-body">
														<a href="{{route('allmassage')}}">
															<h6 class="mb-1">{{$clintmassage->name}}</h6>
															<small class="d-block">{{$clintmassage->email}}</small>
														</a>
													</div>
												</div>
											</li>
							...
							<li class="nav-item dropdown notification_dropdown">
                                <a class="nav-link" href="javascript:void(0)" data-toggle="dropdown">
                                    ...
                                    @if (App\Models\Order::where('position', 'Pending')->count() > 0)
                                    {{App\Models\Order::where('position', 'Pending')->count()}}
                                    <div class="pulse-css text-red"></div>
                                    @endif
                                </a>
								<div class="dropdown-menu dropdown-menu-right rounded">
									<div id="DZ_W_TimeLine11Home" class="widget-timeline dz-scroll style-1 p-3 height370 ps ps--active-y">
										<ul class="timeline">
                                            @foreach (App\Models\Order::where('position', 'Pending')->get() as $order)
                                            <li>
												<div class="timeline-badge primary"></div>
												<a class="timeline-panel text-muted" href="{{route('order.position',$order->id)}}">
													<span>Product Price:- {{$order->subtotal}}</span>
													<h6 class="mb-0">Delicery  {{$order->delivary_charge }}<strong class="text-primary"> Total {{$order->total}}</strong>.</h6>
												</a>
											</li>
                                            @endforeach
										</ul>
                            ...
                            <li class="nav-item dropdown header-profile">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a href="{{route('usersdetails')}}" class="dropdown-item ai-icon">
        ...
        <div class="deznav">
            <div class="deznav-scroll">
				<ul class="metismenu" id="menu">
                    ...
                    <li><a href="{{route('role.manage')}}" class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        <i class="flaticon-381-television"></i>
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{route('add.catagory')}}">Add Category</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
							<i class="flaticon-381-television"></i>
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{route('add.sub_catagory')}}">Add Sub Category</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
							<i class="flaticon-381-television"></i>
                        ...
                        <ul aria-expanded="false">
                            ...
                            <li><a href="{{route('add.product_list')}}">Product List</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
							<i class="flaticon-381-television"></i>
							<span class="nav-text">Inventorire</span>
						</a>
                        <ul aria-expanded="false">
                            <li><a href="{{route('add.color_size')}}">Add Color and size</a></li>
                        </ul>
                    </li>
                    {{-- <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
							<i class="flaticon-381-television"></i>
							<span class="nav-text"> Couppon</span>
						</a>
                        <ul aria-expanded="false">
                            <li><a href="{{route('coupon')}}"> Cuppon</a></li>
                        </ul>
                    </li> --}}
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
							<i class="flaticon-381-television"></i>
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{route('Specific.index')}}">Index</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
							<i class="flaticon-381-television"></i>
                    ...
                    <li><a class="has-arrow ai-icon" href="{{route('add.career')}}" aria-expanded="false">
							<i class="flaticon-381-television"></i>
                    ...
                    {{-- <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
							<i class="flaticon-381-television"></i>
							<span class="nav-text">Add quick Sell</span>
						</a>
                        <ul aria-expanded="false">
                            <li><a href="{{route('phone')}}"> Add Phone quick</a></li>
                        </ul>
                        <ul aria-expanded="false">
                            <li><a href="{{route('audio')}}"> Add Audio quick</a></li>
                        </ul>
                        <ul aria-expanded="false">
                            <li><a href="{{route('promotion')}}"> Add  Promotion</a></li>
                        </ul>
                    </li> --}}
                    {{-- <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
							<i class="flaticon-381-television"></i>
							<span class="nav-text">New arival banner</span>
						</a>
                        <ul aria-expanded="false">
                            <li><a href="{{route('arivalbanner')}}"> Arival Banner</a></li>
                        </ul>
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{route('order.sec')}}"> Orders</a></li>
                        </ul>

                    </li>
                    {{-- <li><a href="{{route('brandsection')}}"class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
							<i class="flaticon-381-television"></i>
							<span class="nav-text">Brand add</span>
						</a>
                    </li> --}}
