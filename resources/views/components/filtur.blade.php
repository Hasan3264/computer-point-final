<div class="header row" style="margin-bottom: 20px;">
    <button class="btn col-xl-3 col-lg-3 col-12 ght btn-light" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight3" aria-controls="offcanvasRight3">
...
<div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight3" aria-labelledby="offcanvasRightLabel3">
    <div class="offcanvas-header">
        <span id="search_minmax" class="btn btnsss btn-primary">Submit</span>
        <button type="button" class="btn-close" data-bs-dismiss="offcanvas" aria-label="Close"></button>
      </div>
    <div class="offcanvas-body">
            <form>
                <h2 class="ssssh2 mb-2">Filture With Brands:-</h2>
                <select class="js-example-basic-single" name="state" id="brands" style="width: 100%">
                    <option value="">Filture By Brands Name</option>
                    @php
                    $uniqueBrandNames = App\Models\Product::where('subcategory_id', $subId)->pluck('brands')->unique();
                    @endphp
                      {{$uniqueBrandNames}}
